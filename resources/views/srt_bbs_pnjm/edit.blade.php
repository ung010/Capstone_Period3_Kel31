    ...
    <div class="d-flex flex-column justify-content-center align-items-center gap-3"
        ...
        <div class="card w-100" id="card-tambah">
            <div class="card-body d-flex flex-column gap-3">
                ...
                <form action="{{ route('srt_bbs_pnjm.update', $data->id) }}" method="POST" class="row px-5">
                    @csrf
                    @if ($errors->any())
                        <div>
                            <ul>
                    ...
                    <div class="col-6">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="dosen_wali" id="dosen_wali" required class="form-control" value="{{ $data->dosen_wali }}">
                            </div>
                            <div class="form-group">
                                <label for="">Alamat Di Semarang</label>
                                <input type="text" name="almt_smg" id="almt_smg" required class="form-control" value="{{ $data->almt_smg }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="jenjang_prodi" name="jenjang_prodi" value="{{ $prodi->nama_prd }}"
                                    class="form-control" readonly>
                            </div>
                            <div class="form-group">
