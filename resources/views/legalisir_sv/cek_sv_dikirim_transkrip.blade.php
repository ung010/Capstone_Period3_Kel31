        ...
        <div class="card d-inline-block intersection-card">
            ...
            <div class="card d-inline-block">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-secondary btn-fixed-size" href="/legalisir/sv/dikirim/ijz_trs">Ijazah dan
                        Transkrip</a>
                </div>
            </div>
        </div>
            ...
            <div class="card-body my-3 px-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex gap-3">
                        @if (Storage::exists('pdf/legalisir/transkrip/' . $legalisir->file_ijazah))
                ...
                <div class="d-flex justify-content-center align-items-center align-content-center gap-3">
                    ...
                    <form action="{{ route('legalisir_sv.setuju_sv_dikirim_transkrip', $legalisir->id) }}" method="POST">
                        @csrf
    ...
    <div class="modal fade" id="tolakModal" tabindex="-1" aria-labelledby="tolakModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('legalisir_sv.tolak_sv_dikirim_transkrip', $legalisir->id) }}" method="POST"
                    id="tolakForm">
                    @csrf
