        ...
        <div class="card d-inline-block intersection-card">
            ...
            <div class="card d-inline-block">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-secondary btn-fixed-size" href="/legalisir/admin/dikirim/ijz_trs">Ijazah dan
                        Transkrip</a>
                </div>
            </div>
        </div>
        <div class="card mt-3">
            <div class="card-body my-3 px-5">
                ...
                <div class="d-flex justify-content-center align-items-center align-content-center gap-3">
                    ...
                    <form action="{{ route('legalisir_admin.admin_dikirim_ijz_trs_setuju', $legalisir->id) }}"
                        method="POST">
                        @csrf
