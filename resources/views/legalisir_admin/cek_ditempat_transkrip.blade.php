        ...
        <div class="card mt-3">
            <div class="card-body my-3 px-5">
                ...
                <div class="d-flex justify-content-center align-items-center align-content-center gap-3">
                    ...
                    <form action="{{ route('legalisir_admin.admin_ditempat_transkrip_setuju', $legalisir->id) }}"
                        method="POST">
                        @csrf
    ...
    <div class="modal fade" id="tolakModal" tabindex="-1" aria-labelledby="tolakModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('legalisir_admin.admin_ditempat_transkrip_tolak', $legalisir->id) }}"
                    method="POST">
                    @csrf
