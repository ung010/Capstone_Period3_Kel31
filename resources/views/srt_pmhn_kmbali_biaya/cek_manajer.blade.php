...
@section('content')
        ...
        <div class="card mt-3">
            <div class="card-body my-3 px-5">
                <div class="d-flex justify-content-center align-items-center align-content-center">
                    <p class="heading-card">CEK DATA - Manajer</p>
                </div>
                ...
                <div class="d-flex justify-content-center align-items-center align-content-center gap-3">
                    ...
                    <form action="{{ route('srt_pmhn_kmbali_biaya.manajer_setuju', $srt_pmhn_kmbali_biaya->id) }}"
                        method="POST">
                        @csrf
    ...
    @include('srt_pmhn_kmbali_biaya.modal_manajer')
@endsection
